                            ...
                            <div className="single-footer-widget">
                                ...
                                <ul className="footer-contact-info">
                                    <li>
                                        ...
                                        Địa chỉ: kp-6, phường Linh Trung, quận Thủ Đức <br /> Thành phố Hồ Chí Minh
                                    </li>
                                    <li>
                                        <i className="fas fa-phone"></i> 
                                        Gọi cho chúng tôi : <a href="tel:(+123) 456-7898">(+123) 456-7898</a>
                                    </li>
                                    <li>
                                        <i className="far fa-envelope"></i> 
                                        Email Us: <a href="mailto:support@novine.com">support@truongson.com</a>
                                    </li>
                                    <li>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <p>Copyright @ 2020 TRUONG SON . All Rights Reserved By <a href="" target="_blank">caycanhtruongson.xyz</a></p>
                            </div>
